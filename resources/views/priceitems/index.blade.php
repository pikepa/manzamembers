                ...
                <div class="flex flex-col ">
                  ...
                  <div class="bg-white shadow-md rounded my-6">
                    <table class="text-left w-full border-collapse"> <!--Border collapse doesn't work on this site yet but it's available in newer tailwind versions -->
                      <thead>
                        <tr>
                          <th class="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border  border-grey-light">Date</th>
                          <th class="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border  border-grey-light">Title</th>
                          <th class="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border  border-grey-light">Price</th>
                      ...
                      <tbody>
                        ...
                        <tr class="hover:bg-grey-lighter">
                          <td class="py-4 px-6 border border-grey-light">{{ $event->Date_of_event }}</td>
                          <td class="py-4 px-6 border border-grey-light"><a href="{{ $event->path() }}">{{ $event->title }}</a></td>
                          <td class="py-4 px-6 border  border-grey-light">{{ $event->formatted_price }}</td>
