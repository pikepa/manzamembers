                      ...
                      <tbody>
                        @foreach($roles as $role)
                            <tr class="hover:bg-grey-lighter">
                              ...
                              <td class="py-2 px-4 border  border-grey-light">{{  $role->permissions()->orderBy('name','asc')->pluck('name')->implode(', ') }}</td>{{-- Retrieve array of roles associated to a user and convert to string --}}
